                                    ...
                                    <div className="slide-view-d">
                                        <ul className="slide-wrap-d">
                                            <li className="slide-d slide1">
                                                <a href="!#">
                                                    <img src={`./images/shop_main_all/${viewed1.slide1}`} alt="" />
                                                </a>
                                            </li>
                                            <li className="slide-d slide2">
                                                <a href="!#">
                                                    <img src={`./images/shop_main_all/${viewed1.slide2}`} alt="" />
                                                </a>
                                            </li>
                                            <li className="slide-d slide3">
                                                <a href="!#">
                                                    <img src={`./images/shop_main_all/${viewed1.slide3}`} alt="" />
                                                </a>
                                            </li>
                                            <li className="slide-d slide4">
                                                <a href="!#">
                                                    <img src={`./images/shop_main_all/${viewed1.slide4}`} alt="" />
                                                </a>
                                            </li>
